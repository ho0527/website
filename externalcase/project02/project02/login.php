    ...
    <body>
        <div class="navigationbar">
            ...
            <div class="navigationbarright">
                <input type="button" class="navigationbarbutton" value="首頁">
                <input type="button" class="navigationbarbutton" value="貨幣">
                <input type="button" class="navigationbarbutton" value="進行">
                <input type="button" class="navigationbarbutton" value="登入">
            </div>
        </div>
        <div class="main">
            <div class="grid">
