        ...
        <form method="POST">
            ...
            <?php
                if($_SESSION["usemod"]=="mark"){
                    ?>
                    <input type="button" class="button selectbutton" onclick="location.href='index.php?testtest='" value="評分版">
                    <input type="button" class="button" onclick="location.href='index.php?test='" value="項次版">
                    <?php
                }elseif($_SESSION["usemod"]=="item"){
                    ?>
                    <input type="button" class="button" onclick="location.href='index.php?testtest='" value="評分版">
                    <input type="button" class="button selectbutton" onclick="location.href='index.php?test='" value="項次版">
                    <?php
                }else{
                    ?>
                    <input type="button" class="button" onclick="location.href='index.php?testtest='" value="評分版">
            ...
            ?><br>
            <input type="button" class="button" onclick="location.href='module.php'" value="模板">
            <input type="button" class="button" onclick="location.href='edit.php'" value="修改模板"><br><br>
            <input type="text" name="tablename" placeholder="名稱">
            <input type="submit" class="button" name="indexsubmit" value="送出"><br><br><br>
            <input type="button" class="button right" onclick="location.href='link.php?logout='" value="登出">
            <?php
                                ...
                                <?php
                                    for($i=0;$i<count($row);$i=$i+1){
                                        ...
                                        <tr>
                                            ...
                                            <td class="border"><input type="text" name="module<?= $i ?>" class="score" placeholder="輸入數字" value="<?= $row[$i][5] ?>" readonly></td>
                                        </tr>
                                        <?php
                                    }
                                ?>
