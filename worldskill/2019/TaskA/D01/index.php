...
<html>
    ...
    <body>
        <?php
            ...
            echo "\$time ="; print_r($time); echo "<br>";
        ?>
        <div class="custom-calendar-wrap">
            <div class="custom-inner">
                <div class="custom-header clearfix">
                    <nav>
                        <a href="index.php?month=<?php echo(date("m",strtotime("-1 month"))) ?>&year=<?php echo date("Y"); ?>" class="custom-btn custom-prev"></a>
                        <a href="index.php?month=<?php echo(date("m",strtotime("+1 month"))) ?>&year=<?php echo date("Y"); ?>" class="custom-btn custom-next"></a>
                    </nav>
                    <h2 id="custom-month" class="custom-month"><?php echo date("F"); ?></h2>
                    <h3 id="custom-year" class="custom-year"><?php echo date("Y"); ?></h3>
                </div>
