        ...
        <?php
            ...
            if(isset($_SESSION["data"])){
                ...
                <div class="loginhead" id="head">
                    <div class="center">
                        <input type="button" class="loginbutton button" onclick="location.href='busmanagement.php'" value="接駁車管理">
                        <input type="button" class="loginbutton button selectbutton" onclick="location.href='sitemanagement.php'" value="站點管理">
                    </div>
                </div>
                <div class="adminpost" id="main">
                    <div class="postbody macossectiondiv">
                        ...
                        <table class="postmessage">
                            ...
                            <?php
                            $row=query($db,"SELECT*FROM `sitemanagement`");
