    ...
    <body>
        ...
        <div class="main">  
            <form action="">
                ...
                <input type="submit" class="but" name="ref" value="重新產生">
                <input type="submit" class="but" name="ref" value="驗證碼重新產生">
                <input type="submit" class="but" name="clear" value="重設">
                <input type="button" class="but" onclick="login()" value="送出按鈕">
            </form>
        </div>
        <?php
            if(isset($_GET["ref"])){
