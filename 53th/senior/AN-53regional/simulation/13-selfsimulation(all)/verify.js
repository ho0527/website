...
function check(){
    ...
    else if(td[0].style.backgroundColor==""&&td[1].style.backgroundColor==""&&td[2].style.backgroundColor=="black"&&td[3].style.backgroundColor=="black") pass()
    else if(td[0].style.backgroundColor=="black"&&td[1].style.backgroundColor=="white"&&td[2].style.backgroundColor=="black"&&td[3].style.backgroundColor=="white") pass()
