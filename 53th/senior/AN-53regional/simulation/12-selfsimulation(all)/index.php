    ...
    <div class="main">
        <form action="">
            ...
            <?php
                ...
                $_SESSION["key"]=$key;
            ?><br>
            <div class="dropbox mag"></div><br>
            <input type="submit" class="mainbutton" name="ref" value="重新產生">
            <input type="submit" class="mainbutton" name="clear" value="重設">
            <input type="button" class="mainbutton" onclick="login()" value="送出按鈕">
        </form>
    </div>
    <?php
        if(isset($_GET["ref"])){
