...
function check(){
    ...
    else if(ver[0].style.backgroundColor==ver[2].style.backgroundColor&&ver[0].style.backgroundColor=="black") pass()
    else if(ver[3].style.backgroundColor==ver[1].style.backgroundColor&&ver[3].style.backgroundColor=="black") pass()
    else alert("驗證碼輸入錯誤")
}