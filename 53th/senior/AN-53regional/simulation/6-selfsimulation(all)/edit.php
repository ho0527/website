        ...
        if(isset($_GET["pedit"])){
            ...
            <div class="main">
                <form id="form" method="post" enctype="multipart/form-data">
                    商品id: <input type="text" name="id" value="<?= @$row[0] ?>" id="" readonly><br>
                    商品名稱: <input type="text" name="name" value="<?= @$row[2] ?>" id=""><br>
                    費用: <input type="text" name="cost" value="<?= @ $row[3]?>" id=""><br>
                    相關連結: <input type="text" name="link" value="<?= @$row[4] ?>" id=""><br>
                    商品簡介: <textarea name="intr" id="" cols="30" rows="3"><?= @$row[6] ?></textarea><br>
                    照片: <input type="file" name="picture" id="" style="width:175px;"><br>
