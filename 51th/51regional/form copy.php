...
<html>
    ...
    <body>
        ...
        ?>
        <script>let count="<?php echo($_SESSION["count"]) ?>"</script>
        <form method="POST">
                        ...
                        for($i=0;$i<$count;$i=$i+1){
                            ...
                            <tr class="div<?php echo($i) ?>">
                                <td rowspan="2" class="order">
                                    <div class="questiondel" id="<?php echo($i) ?>">X</div>
                                    <div id="count<?php echo($i) ?>"><?php if(isset($questionrow[$i][2])){ echo($questionrow[$i][2]); }else{ echo($i+1); } ?></div>
                                </td>
                                <td class="newform">
                                    <?php
                                    ...
                                    for($j=0;$j<count($key);$j=$j+1){
                                        ...
                                        ?><input type="radio" class="radio <?php echo($type) ?>" id="<?php echo($type." ".$i) ?>" name="select<?php echo($i) ?>" value="<?php echo($type) ?>" <?php echo($checked) ?>><?php
                                        echo($mod[$key[$j]]);
                                    }
                                    ...
                                    <td class="output">
                                        <div class="questiondiv" id="output<?= $i ?>">
                                            ...
                                            if($questionrow[$i][5]=="yesno"){
                                                ...
                                                for($j=0;$j<6;$j=$j+1){
                                                    ?>
                                                    <?php echo($j+1) ?>.<input type="text" name="<?php echo($i) ?>single<?php echo($j+1) ?>" class="forminputtext" value="<?php echo($question[$j]) ?>">
                                                    <?php
                                                }
                                            }elseif($questionrow[$i][5]=="multi"){
                                                for($j=0;$j<6;$j=$j+1){
                                                    ?>
                                                    <?php echo($j+1) ?>.<input type="text" name="<?php echo($i) ?>multi<?php echo($j+1) ?>" class="forminputtext" value="<?php echo($question[$j]) ?>">
                                                    <?php
                                                }
                                                ?><br>
                                                <?php
